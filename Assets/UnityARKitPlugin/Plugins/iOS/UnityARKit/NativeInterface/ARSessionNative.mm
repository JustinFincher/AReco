...
- (void)session:(ARSession *)session didUpdateFrame:(ARFrame *)frame
{
        ...
        // Added by FinGameWorks
        // Assign reference to ML Server Here Yo
        if (NSClassFromString(@"MLServerManager") != nil) 
        {
            [[NSClassFromString(@"MLServerManager") performSelector:@selector(sharedManager)] performSelector:@selector(setArSession:) withObject:session];
        }
